...
/***/ function(module, exports, __webpack_require__) {
	...
	var Container = function (_React$Component) {
	  ...
	  _createClass(Container, [{
	    key: 'onInputBoxChange',
	    value: function onInputBoxChange(evt) {
	    ...
	    value: function onSubmitButtonClick(evt) {
	      evt.preventDefault();
	...
	// //   }
	// //   render(){
	// //     console.log(this.props, 'from Item');
	// //     var items = this.props.singleItem.map(function(item, index){
	// //       return <li key={index} className='item'>{items}</li>
	// //     });
	// //     return(
	// //       {items}
	// //     );
...
/***/ }
/******/ ]);
//# sourceMappingURL=ref-test.1.0.0.js.map